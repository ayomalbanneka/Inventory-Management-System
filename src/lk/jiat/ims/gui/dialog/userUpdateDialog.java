...
public class userUpdateDialog extends javax.swing.JDialog {
    ...
    public userUpdateDialog(java.awt.Frame parent, boolean modal, Object userId) {
        super(parent, modal);
        initComponents();
        loadData(userId);
    ...
    private void loadData(Object userID) {

        try {
            ResultSet rs = MySQL.execute("SELECT * FROM `users` WHERE `id` = '" + String.valueOf(userID) + "'");
    ...
    private void initComponents() {
        ...
        status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Active", "Inactive", "Suspended", "Pending" }));
        jPanel2.add(status);
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        try {
            ResultSet rs = MySQL.execute("UPDATE `users` SET "
